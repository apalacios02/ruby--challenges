...
# Calculate the amounts for GST and PST
gst_amount1 = sub_total1 * GST_RATE
pst_amount1 = sub_total1 * PST_RATE
...
puts "PST: $%.2f - %.0f%%" % [pst_amount1, PST_RATE * 100]
puts "GST: $%.2f - %.0f%%" % [gst_amount1, GST_RATE * 100]
...
# Calculate the amounts for GST and PST
gst_amount2 = sub_total2 * GST_RATE
pst_amount2 = sub_total2 * PST_RATE
...
puts "PST: $%.2f - %.0f%%" % [pst_amount2, PST_RATE * 100]
puts "GST: $%.2f - %.0f%%" % [gst_amount2, GST_RATE * 100]
